...
bool G2C::GmeshReader::load(const std::string& fileName, Mesh& mesh){
...
void G2C::GmeshReader::parsePhysicalNames(std::ifstream& inGmsh, Mesh& mesh){
    std::string line;
    //获得PhysicalNames的个数
    int physicalNameNum = 0;
...
void G2C::GmeshReader::parseNodes(std::ifstream& inGmsh, Mesh& mesh){
    std::string line;
    //获得点的个数
    int nodeNum = 0;
    while(std::getline(inGmsh, line)){
...
void G2C::GmeshReader::parseElements(std::ifstream& inGmsh, Mesh& mesh){
    std::string line;
    ///////////////////////////////////////////
    //获得单元的个数
    int elementNum = 0;
